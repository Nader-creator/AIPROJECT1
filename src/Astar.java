...
public class Astar {
	...
	public void updateNeighbor(Node curr, Node destination) {
		List<Node> neighbors = graph.getNeighbors(curr);
		...
		for (Node neighbor : neighbors) {
			...
			Double temp = graph.getWeight(curr, neighbor);
			// If searched already contains neighbor, no need to double check. Continue in
			// loop.
